...
const EmployerSideMenu = ({ showSideMenu, setShowSideMenu }) => {
        ...
        <div className={classes.root}>
            ...
            <List component="nav" className="menu-list-height">
                <ListItem
                    ...
                    onClick={() => {
                        history.push("/profile/e-dashboard");
                        setShowSideMenu(!showSideMenu);
                    }}
                    className={location.pathname === "/profile/e-dashboard" ? classes.active : null}
                >
                    <ListItemIcon>
                ...
                <Collapse in={jobList} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem
                            ...
                            classes={{ root: classes.root, button: classes.button }}
                            onClick={() => {
                                history.push("/profile/e-jobs/all-jobs");
                                setShowSideMenu(!showSideMenu);
                            }}
                            className={location.pathname === "/profile/e-jobs/all-jobs" ? classes.active : null}
                        >
                        ...
                        <ListItem
                            ...
                            classes={{ root: classes.root, button: classes.button }}
                            onClick={() => {
                                history.push("/profile/e-jobs/my-job");
                                setShowSideMenu(!showSideMenu);
                            }}
                            className={location.pathname === "/profile/e-jobs/my-job" ? classes.active : null}
                        >
                            <ListItemIcon></ListItemIcon>
                            <ListItemText
                                classes={{ primary: classes.listItemText }}
                        ...
                        <ListItem
                            ...
                            classes={{ root: classes.root, button: classes.button }}
                            onClick={() => {
                                history.push("/profile/e-postjob");
                                setShowSideMenu(!showSideMenu);
                            }}
                            className={location.pathname === "/profile/e-postjob" ? classes.active : null}
                        >
                            <ListItemIcon></ListItemIcon>
                            <ListItemText
                                classes={{ primary: classes.listItemText }}
                ...
                <Collapse in={talentList} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        ...
                        <ListItem
                            ...
                            classes={{ root: classes.root, button: classes.button }}
                            onClick={() => {
                                history.push("/profile/e-talent/find-talent");
                                setShowSideMenu(!showSideMenu);
                            }}
                            className={location.pathname === "/profile/e-talent/find-talent" ? classes.active : null}
                        >
                            <ListItemIcon></ListItemIcon>
                            <ListItemText
                                classes={{ primary: classes.listItemText }}
                        ...
                        <ListItem
                            ...
                            classes={{ root: classes.root, button: classes.button }}
                            onClick={() => {
                                history.push("/profile/e-talent/manage-talent");
                                setShowSideMenu(!showSideMenu);
                            }}
                            className={location.pathname === "/profile/e-talent/manage-talent" ? classes.active : null}
                        >
                            <ListItemIcon></ListItemIcon>
                            <ListItemText
                                classes={{ primary: classes.listItemText }}
                ...
                <ListItem
                    ...
                    classes={{ root: classes.root, button: classes.button }}
                    onClick={() => {
                        history.push("/profile/e-messages");
                        setShowSideMenu(!showSideMenu);
                    }}
                    className={location.pathname === "/profile/e-messages" ? classes.active : null}
                >
                    <ListItemIcon>
                ...
                <ListItem
                    ...
                    classes={{ root: classes.root, button: classes.button }}
                    onClick={() => {
                        history.push("/profile/e-edit");
                        setShowSideMenu(!showSideMenu);
                    }}
                    className={location.pathname === "/profile/e-edit" ? classes.active : null}
                >
                    <ListItemIcon>
