...
const MobileCallChatModal = (props) => {
    ...
    return (
        ...
        >
            <Modal.Body className='mobile-chat_modal'>
                <div className="mobile-chat_modal-header">
                    <svg style={{cursor: "pointer"}} onClick={props.onHide} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 1.41L12.59 0L7 5.59L1.41 0L0 1.41L5.59 7L0 12.59L1.41 14L7 8.41L12.59 14L14 12.59L8.41 7L14 1.41Z" fill="#333333"/>
                    </svg>
                </div>
                <div className="mobile-chat_modal__body">
                    <div className="mobile-call-chat-container">
                        
                    </div>
                    <div className="messages-can-only-be-seen">
                        <p>Messages can only be seen by people in this call and are deleted when the call is over</p>
                    </div>

                    <div className="bottom-chat-footer mobile-call-chat-bottom">
                        <div className="chat-input-box">
                            <input type="text" className="mobile-call-chat-input" placeholder="Message..." />
                            <div className="chat-input-icons">
                                <div className="inn-chat-input-icons">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M22 2L11 13" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M22 2L15 22L11 13L2 9L22 2Z" stroke="#333333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
