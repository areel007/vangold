...
const Stepper = (props) => {
    ...
    const displaySteps = steps.map((step, index) => {
        ...
        </div> : step.description === 'Expertise' ? <div className={`stepper ${props.stepPage===4 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : step.description === 'Education' ? <div className={`stepper ${props.stepPage===5 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
        ...
        </div> : step.description === 'Employment' ? <div className={`stepper ${props.stepPage===6 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : step.description === 'Rate' ? <div className={`stepper ${props.stepPage===7 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : step.description === 'Language' ? <div className={`stepper ${props.stepPage===8 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : <div className={`stepper ${props.stepPage===9 ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
