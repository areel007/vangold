...
const ManageTalentChat = () => {

    return (
        <section>
            <div className="MessageBox__">
                <div className="ChatBox__ ManageTalent__ChatBox__">
                    ...
                    <div className="ChatBox__Footer ManageTalent__ChatBox__Footer">
...
export default ManageTalentChat;