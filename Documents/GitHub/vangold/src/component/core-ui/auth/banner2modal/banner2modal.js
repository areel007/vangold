...
const BannerTwoModal = () => {
  ...
  return (
    <form className="sign-up__form sign-up__form2">
      ...
      <div className="signin__terms">
        <input
          ...
          value="signinterms"
        ></input>
        <label htmlFor="signinterms" className="login-label">
          {" "}
      ...
      <div className="icon-btns">
        ...
        <p className="bannerAlready-have-acct">Already have an account? <a href="#">Sign in</a></p>
      </div>
    </form>
  );
};

export default BannerTwoModal;
