    ...
    return (
        <div className="message__box-component2">
            <div className="message__box-component2_header">
                ...
                <div ref={ref} className={isShow2 ? 'message-chat-box-members-none' : 'business-chat-box-members '}>
            ...
            <div className="chat-messager-container">
                <div className="send-message">
                    <div className="inn-send-message">
                ...
                <div className="middle-message-time-date">June 20, 10:46 pm</div>
                <div className="reply-message">
                    <div className="replied-message-to">
                        Replied to Damola
                    </div>
                    <div className="inn-reply-message">
                        Hey, Devon. Can we get on a quick call?
                    </div>
                    <div className="inn-reply-message2">
                    ...
                    <div style={{marginTop: 24}} className="inn-reply-message2">
                        <span className="replyName">Femi</span>
                ...
                <div className="reply-message">
                    <div style={{marginTop: 24}} className="inn-reply-message2">
                        <span className="replyName">Tola</span>
