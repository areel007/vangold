            ...
            <div className="MessageBox__">
                ...
                <div className="ChatBox__">
                    <div className="ChatBox__sendMsg">
                        <div className="Inn__ChatBox__sendMsg Mobile__Inn__ChatBox__sendMsg">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum odio feugiat donec imperdiet aliquam vel, penatibus
                        </div>
                    ...
                    <div className="ChatBox__replyMsg">
                        <div className="Inn__ChatBox__replyMsg Mobile__Inn__ChatBox__replyMsg">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mi sed tempus convallis
                        </div>
                    ...
                    <div className="ChatBox__replyMsg">
                        <div className="Inn__ChatBox__replyMsg Mobile__Inn__ChatBox__replyMsg">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mi sed tempus convallis faucibus.
                        </div>
                        <div className="ChatBox__replyMsg__time">
                            Saturday 11:50 PM
                        </div>
