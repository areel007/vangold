                ...
                <form id="myform" onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-input__container">
                        ...
                        <div className="form__-control add__guests__">
                            ...
                            <input name="addGuests" type="name" {...register('addGuests')} className={`form-control addGuests__input ${errors.addGuests ? 'is-invalid' : ''}`} />
                            <div className="invalid-feedback">{errors.addGuests?.message}</div>
