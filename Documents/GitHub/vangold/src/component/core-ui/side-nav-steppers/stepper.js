...
const Stepper = (props) => {
    ...
    const displaySteps = steps.map((step, index) => {
        return step.description === 'Personal Info' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
        ...
        </div> : step.description === 'Description' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
        ...
        </div> : step.description === 'Category' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
        ...
        </div> : step.description === 'Expertise' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
        ...
        </div> : step.description === 'Education' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
        ...
        </div> : step.description === 'Employment' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : step.description === 'Rate' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : step.description === 'Language' ? <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </div> : <div className={`stepper ${step.selected ? 'stepper-active' : null}`}>
            <div className="stepper-icon">
